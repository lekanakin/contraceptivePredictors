...
def main():
	""" Machine Learning App with Streamlit for Contraceptive Choice Prediction"""
	...
	st.sidebar.info("ML App for Contraceptive Prediction")
	st.sidebar.text("This app is still a work in progress")
	if st.sidebar.button("About"):
		st.sidebar.text("Lekan Akinsande")
		st.sidebar.text("GitHub: lekanakin")
